...
const AuthPage = () => {
    ...
    const { loading, setLoading, openNotiSuccess, openNotiError } = useAppContext();
        ...
        <Spin spinning={loading}>
            <div className='grid grid-cols-5'>
                <div className="col-span-3">
                    <img src={Banner} alt="Banner" className='w-full object-cover bg-left-bottom bg-cover' />
                </div>
                <div className="col-span-2 p-[72px]">
                    ...
                    <Form onFinish={onFinish} layout='vertical'>
                        ...
                        >
                            <Input className='p-3' placeholder='Enter your mail' />
                        </Form.Item>
                        <Form.Item
                            name="password"
                            label="Password"
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <p className='cursor-pointer underline font-bold'>Forgot password?</p>
                        </div>

                        <div className='h-[30px]'></div>

                        <Button htmlType='submit' block type="primary" className='h-[50px]'>
                            Log in
                        </Button>
                    </Form>
                </div>
